import { ArrowRightCircle, File, FilePlus, Leaf, PlusCircle } from "lucide-react";
import Link from "next/link";
import { Badge } from "../shadcn/badge";

export default function ProjectHomeCard({user, date, title, category, isCreate, href, priority} : {user?: string, date?: string, title?: string, category?: string, isCreate?: boolean, href?: string, priority?: string}) {
    if(isCreate) {
        return (
